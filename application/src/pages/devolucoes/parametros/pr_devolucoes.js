...
export const parametrosDevolucoes = [
    ...
    { id: 2, atributo: 'id', rotulo: 'Venda', tipo: 'autoComplete', url: urlServer + "/vendas/", atributoVisivel: 'data' },
    ...
    { id: 5, atributo: 'valorDevolvido', rotulo: 'Valor devolvido', tipo: 'currency' },
]