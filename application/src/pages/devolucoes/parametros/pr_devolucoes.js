...
export const parametrosDevolucoes = [
    ...
    { id: 2, atributo: 'vendaId', rotulo: 'Venda', tipo: 'autoComplete', url: urlServer + "/vendas/", atributoVisivel: 'data' },
    { id: 3, atributo: 'mercadoriaId', rotulo: 'Mercadoria devolvida', tipo: 'autoComplete', url: urlServer + "/mercadorias/", atributoVisivel: 'nome' },
