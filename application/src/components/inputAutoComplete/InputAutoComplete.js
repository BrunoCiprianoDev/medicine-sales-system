...
const InputAutoComplete = ({attribute, url, setValue, attributeVisible, hookForm}) => {
    ...
    const handleInsert = (item) =>{
        ...
        hookForm ? setValue(attribute, item.id) : setValue(item[attribute])
    }
  ...
  return (
    <div className={styles.ContainerForm}>
      <div className={styles.InputBox}>
        <input className={styles.InputComponent} type="text" value={inputSearch} onChange={(e)=>handleOnChange(e.target.value)}  required/>
